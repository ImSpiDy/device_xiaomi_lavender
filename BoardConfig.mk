...
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 67108864 # Always ext4 read-write (Including erofs GApps)
...
else # (Erofs read-only except vendor partition)
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := erofs
#BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := erofs # Always ext4 read-write
endif
else # (Vanilla with 2GB reserved space for GApps)
